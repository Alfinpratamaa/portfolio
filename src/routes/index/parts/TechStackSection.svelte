...
<section class="tech-stack-section" style="--accent:{accent};">
  ...
  <p class="sub-info">
    I have worked with a variety of technologies, and I enjoy learning new ones.
    Here are some of the languages and frameworks I've used in my projects.
  </p>
  <p class="sub-info">
    The projects listed are public repositories on GitHub, showcasing my work
    with these technologies. If you want to see more, check out my GitHub
    profile.
  </p>
  <div class="stack-table">
    <p class="hover-info">
      Hover over the language badges to see the number of public projects built
      with that language.
    </p>
