    ...
    {#each projects.slice(0, projectCount) as project, index}
      <li>
        ...
        >
          <span class="txt"
            >{project.name}
            {#if project.isFork}<span class="fork"
                ><Icon name="fork" height="10" />FORK</span
              >{/if}
          </span>
            ...
            <div class="more-stats">
              ...
              {#if project.license && project.license !== 'Other'}
                <div
                  ...
                  title="Licensed under {project.license}"
                >
              ...
              {#if project.size && project.size > 500}
                <div
                  class="info-item size-value"
                  title="Size: {project.size} KB"
                >
