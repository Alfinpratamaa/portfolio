...
<main class="homepage">
  <!-- <Heading
    ...
    blinkCursor={true}
    size="4rem"
    color="var(--home-accent-background)">Alfin Pratama</Heading
  > -->
    ...
    {#each homePageLinks as navLink}
      ...
      >
        <Heading
          level="h3"
          size="1.4rem"
          color="var(--home-accent-foreground)"
          weight={600}>{navLink.label}</Heading
        >
  ...
  :global(body) {
    &::after {
      ...
      background: radial-gradient(
        var(--home-animated-gradient-inner),
        var(--home-animated-gradient-outer) 50%
      );
      opacity: 0;
